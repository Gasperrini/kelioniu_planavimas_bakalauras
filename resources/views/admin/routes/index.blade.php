...
@section('content')
    <div class="app-title">
        ...
        <a href="{{ route('admin.routes.create') }}" class="btn btn-primary pull-right">Pridėti</a>
    </div>
                ...
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                <th> Pavadinimas </th>
                                <th class="text-center"> Pradine stotele </th>
                                <th class="text-center"> Galine stotele </th>
                                <th class="text-center"> Isvyksta </th>
