...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                <h3 class="tile-title">Redaguoti maršrutą</h3>
                <form action="{{ route('admin.routes.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="start_point">Pradinė stotelė<span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="end_point">Galinė stotelė<span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <div class="form-group">
                            <label class="control-label" for="start_time">Išvykimo laikas<span class="m-l-5 text-danger"> *</span></label>
                    ...
                    <h4 class="tile-title">Maršruto stotelės</h4>
                    @foreach($segments as $segment)
                    @if($segment->route_id == $route->route_code)
                    <div class="tile-body">
                        <div class="form-group">
                            <label class="control-label" for="stop">Stotelė<span class="m-l-5 text-danger"> *</span></label>
